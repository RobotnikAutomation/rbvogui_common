...
class DockingTester(Node):
    ...
    def dockRobot(self, dock_pose, dock_type = "rbvogui_dock"):
        ...
        goal_msg.dock_id = 'home_dock'  # if wanting to use ID instead
        # goal_msg.dock_pose = dock_pose
        goal_msg.dock_type = dock_type
        goal_msg.navigate_to_staging_pose = False  # if want to navigate before staging
    ...
    def startup(self, node_name='robot/docking_server'):
...
def main():
    ...
    while True:
        ...
        dock_pose.header.frame_id = "robot_base_link"
